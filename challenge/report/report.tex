...
\title{NTT Data ML Challenge 2025 \\ \large Portuguese Fake News Detection}
...
\author{
  Daniel Martins Borges, Duarte Pereira da Cruz \\
  \texttt{daniel.m.borges@tecnico.ulisboa.pt, duarte.cruz@tecnico.ulisboa.pt} \\
  Group 9 \\
